...
import javaapplication1.Restuarant;

/**
 *
 * @author hossa
 */
public class gui_AddRestaurant extends javax.swing.JFrame {
    private Admin admin;
  
    /**
     * Creates new form testa
     */
    public gui_AddRestaurant() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Restaurant Location");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       int id=Integer.parseInt(jTextField1.getText());
        ...
        Restuarant r = new Restuarant(id,name,location);
        admin.addRestuarant(r);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gui_AddRestaurant.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new gui_AddRestaurant().setVisible(true);
            }
        });
    }
